...
// @Security BearerAuth
// @Success 200
// @Router /api/master-pd105/export/rpt1 [get]
func JsonPD101(c *fiber.Ctx) error {
    ...
    for _, d := range ls {
        ...
        m := fiber.Map{
            ...
            "dateOfDeath":                      fmt.Sprintf("%s 00:00:00", d["DEATH_DATE"]),
            "mortuaryRegTime":                  fmt.Sprintf("%s 00:00:00", d["DEATH_DATE"]),
            "causesOfDeath":                    "00",
            "certificateNo":                    "00",
            "medicoLegal":                      "00",
            "autopsy":                          "00",
...
// @Security BearerAuth
// @Success 200
// @Router /api/master-pd105/export/rpt1/xlsx [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/master-pd105/rpt1 [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/master-pd105/rpt1 [post]
...
// @Security BearerAuth
// @Success 200
// @Router /api/master-pd105/rpt1/{id} [put]
...
func getDb(cli *mongo.Client) *mongo.Database {
    ...
    s := fmt.Sprintf("master_pd105%s", suffix)
    db := cli.Database(s)
    return db
}
