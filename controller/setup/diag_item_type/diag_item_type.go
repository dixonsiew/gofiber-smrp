...
var table string = "diag_item_type"

// LookupList
//
// @Tags Setup/DiagItemType
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/diag-item-types [get]
...
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/diag-item-types [get]
...
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/diag-item-types [post]
...
// @Security BearerAuth
// @Success 200
// @Router /api/diag-item-type [post]
...
// @Router /api/diag-item-type/{id} [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/diag-item-type/{id} [put]
...
// @Security BearerAuth
// @Success 200
// @Router /api/diag-item-type/{id} [delete]
