...
var table string = "person_category_code"

// LookupList
//
// @Tags Setup/Person Category Code
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/person-category-codes [get]
...
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/person-category-codes [get]
...
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/person-category-codes [post]
...
// @Security BearerAuth
// @Success 200
// @Router /api/person-category-code [post]
...
// @Router /api/person-category-code/{id} [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/person-category-code/{id} [put]
...
// @Security BearerAuth
// @Success 200
// @Router /api/person-category-code/{id} [delete]
