...
var table string = "occupation"

// LookupList
//
// @Tags Setup/Occupation
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/occupations [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/occupation/{id} [delete]
