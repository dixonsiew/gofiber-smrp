...
var table string = "delivery_type"
...
// @Router /api/lookup/delivery-types [get]
...
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/delivery-types [post]
...
// @Router /api/delivery-type/{id} [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/delivery-type/{id} [put]
