...
var table string = "ward_class"

// LookupList
//
// @Tags Setup/WardClass
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/ward-classes [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/ward-class/{id} [delete]
