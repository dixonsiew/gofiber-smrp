...
var table string = "visit_type"

// LookupList
//
// @Tags Setup/VisitType
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/visit-types [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/visit-type/{id} [delete]
