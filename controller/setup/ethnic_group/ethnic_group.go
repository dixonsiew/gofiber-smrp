...
var table string = "ethnic_group"

// LookupList
//
// @Tags Setup/EthnicGroup
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/ethnic-groups [get]
...
// @Router /api/ethnic-group/{id} [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/ethnic-group/{id} [put]
...
// @Security BearerAuth
// @Success 200
// @Router /api/ethnic-group/{id} [delete]
