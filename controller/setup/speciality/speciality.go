...
var table string = "speciality"

// LookupList
//
// @Tags Setup/Speciality
// @Produce json
// @Security BearerAuth
// @Success 200 {array} model.CommonSetup
// @Router /api/lookup/specialities [get]
...
// @Security BearerAuth
// @Success 200
// @Router /api/speciality/{id} [delete]
